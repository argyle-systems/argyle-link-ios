...
1. In the `Podfile` of your Xcode project, add `pod 'Argyle', '5.2.3'` ([example Podfile](https://github.com/argyle-systems/argyle-link-ios/blob/master/ArgyleExample/Podfile))
